...
const AdminTours = () => {
    ...
    return (
        <div className="p-6"><div className="flex justify-between items-center mb-4"><h1 className="text-2xl font-bold">Manage Tours</h1><Button onClick={() => { setEditing(null); setFormData({ guide_group: '', tour_name: '', description: '', total_seats: '', price_per_person: '', discount_percentage: '0', status: 'upcoming' }); setShowModal(true); }} icon={FaPlus}>Add</Button></div>
