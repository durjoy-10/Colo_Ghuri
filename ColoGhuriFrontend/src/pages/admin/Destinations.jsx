...
const AdminDestinations = () => {
    ...
    const fetchDestinations = async () => { const data = await get('/destinations/'); setDestinations(data.results || data); };
    ...
    return (
        <div className="p-6"><div className="flex justify-between items-center mb-4"><h1 className="text-2xl font-bold">Manage Destinations</h1><Button onClick={() => { setEditing(null); setFormData({ name: '', description: '', location: '', destination_type: 'beach', entry_fee: '', best_time_to_visit: '', opening_hours: '', is_popular: false }); setShowModal(true); }} icon={FaPlus}>Add</Button></div>
